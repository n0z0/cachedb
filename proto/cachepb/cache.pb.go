...
type SetRequest struct {
	...
	TtlSeconds    int32                  `protobuf:"varint,3,opt,name=ttl_seconds,json=ttlSeconds,proto3" json:"ttl_seconds,omitempty"` // 0 = tanpa TTL
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_cache_proto_rawDesc = "" +
	...
	"\x02ok\x18\x01 \x01(\bR\x02ok2\x9a\x01\n" +
	"\x05Cache\x12,\n" +
	...
	"\x06Delete\x12\x14.cache.DeleteRequest\x1a\x15.cache.DeleteResponseB\n" +
...
var file_cache_proto_depIdxs = []int32{
	...
	3, // 4: cache.Cache.Set:output_type -> cache.SetResponse
